...
- [`skills/coding-discipline/`](skills/coding-discipline/SKILL.md) — behavioral guidelines for coding with an LLM (think before coding, simplicity first, surgical changes, goal-driven execution). Adapted from [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills/).
- [`skills/awesome-skills.md`](skills/awesome-skills.md) — curated list of third-party Claude skills worth knowing about, grouped by category, with a short description of what each one does.
