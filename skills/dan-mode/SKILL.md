...
- Shipping UI / IDE / CLI → the matching control skill: the **run** skill drives CLIs, TUIs, Electron, and browser-driven surfaces. For bug fixes, reproduce first on the same surface yourself. Hand to the user only under the narrow Bug fix step 1 exception.
